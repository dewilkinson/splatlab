...
- **Detach Camera** freezes the culling camera where it is and lets you fly around to see what it could see. Surfels and the occlusion volume are culled against the frozen camera, and its frustum is drawn.
